...
If you find a security vulnerability in solon, please report it through [GitHub's private vulnerability reporting](https://github.com/warmoss/solon/security/advisories/new). This keeps the details private while we work on a fix.
