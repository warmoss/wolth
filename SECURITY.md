...
If you find a security vulnerability in wolth, please report it through [GitHub's private vulnerability reporting](https://github.com/warmoss/wolth/security/advisories/new). This keeps the details private while we work on a fix.
...
**Enterprise support** is available, with priority response SLAs. Contact maks@sapling.ink for details.
